...
const MobileScrollMenu = () => {
  ...
  return (
    <div className="sm:hidden fixed bottom-6 left-0 right-0 px-8 flex justify-between items-center gap-x-4 overflow-x-scroll text-xl text-primary-blue font-source-han-serif pointer-events-auto z-999999">
