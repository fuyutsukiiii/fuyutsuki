...
const Contact = () => {
  return (
    <div className="h-screen w-screen bg-primary-gray flex flex-col px-6 pt-8 md:pt-0 md:px-0 md:grid md:grid-rows-[2fr_8fr_1fr] md:grid-cols-[1fr_10fr_3fr_1fr_3fr_10fr_1fr] z-1 overscroll-contain">
      <GrayGrid />
